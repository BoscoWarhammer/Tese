...
\usepackage{pgfplots}                                       % Cria bons ambientes para desenhar equações e pontos
\usetikzlibrary{backgrounds}
%\usepackage{breqn}                                          % Alows breaking equations
...
\include{./01-elementos-pre-textuais/resumo-en}             % Resumo na língua vernácula
\include{./01-elementos-pre-textuais/resumo-pt}             % Resumo em língua inglesa
\include{./01-elementos-pre-textuais/resumo-fr}             % Resumo em língua francesa
...
\include{./02-elementos-textuais/metodologia-DEM}           % Metodologia DEM
\include{./02-elementos-textuais/fundamentacao-teorica-BNE} % Fundamentação teórica - BNE
\include{./02-elementos-textuais/resultados-BNE}            % Resultados
\include{./02-elementos-textuais/metodologia-CFD}           % Metodologia CFD
\include{./02-elementos-textuais/fundamentacao-teorica-Fluido} % Fundamentação teórica - Fluido
\include{./02-elementos-textuais/resultados-Fluido}         % Resultados
